...
if (/\bgit\s+commit\b/.test(cmd)) {
  ...
  // Не считаем упоминанием части путей и имён файлов оснастки: .claude/,
  // CLAUDE.md, claude-код в путях. Ловим только «голое» слово.
  if (/(?<![.\w\\/-])(claude|anthropic|assistant)(?!\.md)(?![\\/])/i.test(scan)) {
    deny(
